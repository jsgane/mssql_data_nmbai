...
def create_snowflake_table(
    ...
    Args:
        ...
        table_schema: DDL des colonnes (optionnel, sinon utilise le schéma par défaut)
...
def copy_into_table():
    ...
    try:
        ...
        logger.info(f"🔄 Chargement dans {Config.SF_TABLE}...")
        start_time = time.time()
        ...
        # Vérification finale
        cursor.execute(f"SELECT COUNT(*) FROM {Config.SF_TABLE}")
