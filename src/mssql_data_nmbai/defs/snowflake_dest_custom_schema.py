...
def create_snowflake_table(
    ...
    ##    custom_schema = extract_mssql_table_schema()
    ## dans cette fonction mettre les bon types snowflake pour les decimal et les dates
...
if __name__ == "__main__":
    ...
    '''
    #custom_schema == custom_schema_v_inv_part
    setup_snowflake(table_name="AI_V_Inventory_Parts_Ops", custom_schema = custom_schema_v_inv_part)
    upload_to_stage()
